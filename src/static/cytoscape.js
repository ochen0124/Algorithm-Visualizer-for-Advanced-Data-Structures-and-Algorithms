...
function addedge(){
    ...
    /*
    console.log(elabel.value)
    console.log(elabel.value.isInteger())

    if (parseInt(elabel.value) <= 0){
        console.log("yayaya")
        document.getElementById("error").innerText = "Edge weights must be positive"
        return
    }
    */
